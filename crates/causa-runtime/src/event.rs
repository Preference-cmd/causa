...
fn committed_calls(
    call_index: &HashMap<causa_kernel::BlockId, ToolCallPayload>,
...
fn call_index(context: &TurnContext) -> HashMap<causa_kernel::BlockId, ToolCallPayload> {
    context
        .blocks()
        .iter()
...
mod tests {
    ...
    fn completed() -> TurnResult {
        TurnResult::Completed {
            final_output: causa_kernel::ModelOutput {
                stop_reason: ModelStopReason::EndTurn,
                usage: None,
                reasoning: None,
    ...
    fn collector_maps_deltas_and_skips_terminal_ones() {
        ...
        let deltas = vec![
            ...
            StreamDelta::Usage(causa_kernel::ModelUsage {
                input_tokens: 1,
                output_tokens: 2,
            ...
            StreamDelta::Error {
                kind: causa_kernel::ModelInvokeErrorKind::Transient,
                message: "x".into(),
            },
        ];
