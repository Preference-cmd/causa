...
use reimagine_agent_runtime::{
    RunControl, ToolExecutor, TurnLimits, TurnPolicy, TurnRunOptions, TurnRunner,
};
...
#[async_trait]
impl reimagine_agent_runtime::ToolUseHook for TestDedupHook {
    async fn apply(
        &self,
        calls: Vec<reimagine_context_kernel::ToolCallPayload>,
        _ctx: &reimagine_agent_runtime::HookCtx<'_>,
    ) -> reimagine_agent_runtime::HookOutcome {
